...
from tensorflow.python.keras.models import model_from_json,load_model,Sequential
...
from tensorflow.python.keras.layers import Dense,Dropout,Activation,Flatten,MaxPooling2D,Convolution2D
